	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-9 col-xs-12 margin-top-md">
              ...
              </h4> 日差しも強くなってきました。そろそろ海が恋しい季節。潮風を感じながら砂浜を散歩するのも気持ちいいですね。クレセントシューズおすすめの洗濯機でも洗えるスニーカー、夏のニーズにお応えしてお手入れもラクラクです。 </div>
					</div>
				</div>
				<div class="well well-lg">
					<div class="media">
              ...
              </h4> 雨の日のお出かけにはどの靴を履いていくか迷うことありませんか？クレセントシューズのレインシューズは強力な防水加工かつ靴の中がむれない構造になっていて雨の日でも安心です。 </div>
					</div>
				</div>
				<div class="well well-lg">
					<div class="media">
            ...
            </h4> お待たせしました！これまで在庫切れで入手が困難だったクレセントシューズイチオシのトレッキングシューズが再入荷です。身体を動かすと気持ちのよい季節、さわやかな風を感じて登山はいかがでしょう？ </div>
					</div>
				</div>
				<div class="well well-lg">
					<div class="media">
            ...
            </h4> 春色のパステルカラー！たくさんの明るい色が店内を飾っています。足元から明るく、お出かけの気分を上げていきましょう！たくさん歩いても大丈夫、ローヒールの靴もたくさん入荷しております。ぜひ店舗にも足をお運びください。 </div>
					</div>
				</div>
				<div class="well well-lg">
					<div class="media">
          ...
          </h4> 凍えたていた大地にやわらかい日差しがさしてきましたね。そろそろ春の準備です。お散歩にも最適のウォーキングシューズはいかがですか？ウォークラインを考慮した構造で足への負担をやわらげています。ぜひ一度お試しください。 </div>
					</div>
				</div>
			</div>
